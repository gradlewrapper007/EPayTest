...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context) {
        this(context, null, R.styleable.RoundImageViewStyle_rimDefault);
    }

    public RoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.RoundImageViewStyle_rimDefault);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        hasBorder = attributes.getBoolean(R.styleable.RoundImageView_rim_border, false);
        hasSelector = attributes.getBoolean(R.styleable.RoundImageView_rim_selector, false);
        shadowEnabled = attributes.getBoolean(R.styleable.RoundImageView_rim_shadow, SHADOW_ENABLED);

        // Set border properties, if enabled
        if (hasBorder) {
            int defaultBorderSize = (int) (2 * context.getResources().getDisplayMetrics().density + 0.5f);
            setBorderWidth(attributes.getDimensionPixelOffset(R.styleable.RoundImageView_rim_borderWidth, defaultBorderSize));
            setBorderColor(attributes.getColor(R.styleable.RoundImageView_rim_borderColor, Color.WHITE));
        }

        // Set selector properties, if enabled
        if (hasSelector) {
            int defaultSelectorSize = (int) (2 * context.getResources().getDisplayMetrics().density + 0.5f);
            setSelectorColor(attributes.getColor(R.styleable.RoundImageView_rim_selectorColor, Color.TRANSPARENT));
            setSelectorStrokeWidth(attributes.getDimensionPixelOffset(R.styleable.RoundImageView_rim_selectorStrokeWidth, defaultSelectorSize));
            setSelectorStrokeColor(attributes.getColor(R.styleable.RoundImageView_rim_selectorStrokeColor, Color.BLUE));
        }

        // Set shadow properties, if enabled
        if (shadowEnabled) {
            shadowRadius = attributes.getFloat(R.styleable.RoundImageView_rim_shadowRadius, SHADOW_RADIUS);
            shadowDx = attributes.getFloat(R.styleable.RoundImageView_rim_shadowDx, SHADOW_DX);
            shadowDy = attributes.getFloat(R.styleable.RoundImageView_rim_shadowDy, SHADOW_DY);
            shadowColor = attributes.getColor(R.styleable.RoundImageView_rim_shadowColor, SHADOW_COLOR);
    ...
    /**
     * Sets the WidgetCircularImageView's border width in pixels.
     *
    ...
    /**
     * Sets the WidgetCircularImageView's basic border color.
     *
     ...
     * WidgetCircularImageView. Be sure to provide some opacity.
     *
    ...
    /**
     * Sets the stroke width to be drawn around the WidgetCircularImageView
    ...
    /**
     * Sets the stroke color to be drawn around the WidgetCircularImageView
     * during click events when the selector is enabled.
     *
    ...
    /**
     * Enables a dark shadow for this WidgetCircularImageView.
     *
